    ...
    function (
        ...
        return Component.extend({
            ...
            placeOrder: function (data, event) {
                ...
                var tokenParams = {
                   "card": {
                      "type":      $("#conekta_card_cc_type").val(),
                      "number":    $("#conekta_card_cc_number").val(),
                      "name":      $("#conekta_card_cc_owner").val(),
                      "exp_year":  $("#payment[cc_exp_year]").val(),
                      "exp_month": $("#payment[cc_exp_month]").val(),
                      "cvc":       $("#payment[cc_cid]").val(),
                    }
                  };
             
                console.log(  window.checkoutConfig.conekta.sandboxpublic  );
                console.log(  window.checkoutConfig.conekta.sandboxprivate  );
                Conekta.setPublishableKey(window.checkoutConfig.conekta.sandboxpublic);
                Conekta.setPublishableKey(window.checkoutConfig.conekta.prodpublickey);
